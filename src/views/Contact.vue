...
export default class Contact extends Vue {
  private contactLinks: any = [
    ...
    },
    {
      ...
      icon: 'email',
      link: 'mailto:brandoncash@gmail.com',
    },
    {
      name: 'LinkedIn',
...
<template>
  <main>
    <ContentBlock>
      ...
      <p>
        I am currently seeking a full-time position as a senior web developer. If <router-link to="skills">my set of skills</router-link> will augment your team, please use one of the below links to get in touch!
      </p>

      <div class="contact-grid">
        <a
          v-for="(contact, contactIndex) in contactLinks"
          :key="contactIndex"
          class="contact-item"
          :href="contact.link"
          target="_blank"
...
.contact-item .interior,
.contact-item .exterior {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
